	...
	function widget($args, $instance){
		...
		?>
	        <div class="row">
	        	...
	        	<?php $postdata = mars_get_post_data( get_the_ID() );?>
	            <div id="post-right-<?php print $this->id; ?>-<?php the_ID();?>" <?php post_class('col-md-'.esc_attr( $widget_column ).' col-sm-'. esc_attr( $tablet_columns ) .' col-xs-'.esc_attr( $mobile_columns ).' item responsive-height'); ?>>
	            	<?php 
