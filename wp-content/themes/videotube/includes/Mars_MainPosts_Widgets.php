	...
	function widget($args, $instance){
		...
		?>
			<?php if( $widget_column == 3 ):?>
          	...
          	<?php else:?>
          		<div id="carousel-latest-<?php print $this->id; ?>" class="carousel carousel-<?php print esc_attr( $this->id )?> slide video-section" <?php if($post_shows>3):?> data-ride="carousel"<?php endif;?>>
          	<?php endif;?>
					...
					<div class="section-header">
                   	...
                   	<?php if( $widget_column == 2 ):?>
						...
						<div id="post-main-<?php print $this->id; ?>-<?php the_ID();?>" <?php post_class('col-md-'.$class_columns.' responsive-height item');?>>
							<?php 
	                       	...
	                       	if( $wp_query->have_posts() ) : 
		                       	...
		                       	<?php endif;?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 item list post <?php print $this->id; ?>-<?php print get_the_ID();?>">
                                        	<div class="post-header">
			                     ...
			                     <div class="carousel-inner">
			                       	...
			                       	if( $wp_query->have_posts() ) : 
				                       	...
				                       	<?php if( $i == 1 ):?>
				                       		<div class="item active">
				                       	<?php endif;?>	
				                       		<div id="post-main-<?php print $this->id; ?>-<?php the_ID();?>" <?php post_class('col-md-'.$class_columns.' col-sm-'. esc_attr( $tablet_columns ) .' col-xs-'. esc_attr( $mobile_columns  ));?>>
												<?php 
													if(has_post_thumbnail()){
