...
jQuery(document).ready(function(){ 
	...
	var DIV_SIZE = [
		['1/4','element1-4',1/4,['Column','Gallery','Contact-Form','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['1/3','element1-3',1/3,['Column','Gallery','Contact-Form','Content','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['1/2','element1-2',1/2,['Donation-Widget','Contact-Form','Column','Gallery','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['2/3','element2-3',2/3,['Column','Gallery','Contact-Form','Content','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['3/4','element3-4',3/4,['Column','Gallery','Contact-Form','Content','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['1/1','element1-1',1,['Widget','Column','Gallery','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Services-Widget','Text-Widget','Contact-Form','Price-Item']]
	];
	...
	jQuery('select#page-option-top-slider-types').change(function(){
		if(jQuery(this).val()=='No Slider'){
			jQuery(this).parents('.meta-body').siblings('#cp-top-slider-wrapper').slideUp();
			jQuery(this).parents('.meta-body').siblings('#cp-layer-slider-wrapper').slideUp();
		}else if(jQuery(this).val()=='Layer Slider'){
			jQuery(this).parents('.meta-body').siblings('#cp-top-slider-wrapper').slideUp();
			jQuery(this).parents('.meta-body').siblings('#cp-layer-slider-wrapper').slideDown();
		}else{
			jQuery(this).parents('.meta-body').siblings('#cp-top-slider-wrapper').slideDown();
			jQuery(this).parents('.meta-body').siblings('#cp-layer-slider-wrapper').slideUp();
		}
	});
	jQuery('select#page-option-top-slider-types').each(function(){
		if(jQuery(this).val()=='No Slider'){
			jQuery(this).parents('.meta-body').siblings('#cp-top-slider-wrapper').css('display','none');
			jQuery(this).parents('.meta-body').siblings('#cp-layer-slider-wrapper').css('display','none');
		}else if(jQuery(this).val()=='Layer Slider'){
			jQuery(this).parents('.meta-body').siblings('#cp-top-slider-wrapper').css('display','none');
			jQuery(this).parents('.meta-body').siblings('#cp-layer-slider-wrapper').css('display','block');
		}else{
			jQuery(this).parents('.meta-body').siblings('#cp-top-slider-wrapper').css('display','block');
		}
	});
