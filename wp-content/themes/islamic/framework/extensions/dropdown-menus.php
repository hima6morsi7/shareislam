...
class DropDown_Menu_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'dropdown-menu-widget', 'description' => __( 'Use this widget to add one of your custom menus as a dropdown.','crunchpress' ) );
		parent::__construct( 'dropdown_menu', __('Dropdown Menu','crunchpress'), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'nav_menu' ); ?>"><?php _e( 'Select Menu:','crunchpress' ); ?></label>
