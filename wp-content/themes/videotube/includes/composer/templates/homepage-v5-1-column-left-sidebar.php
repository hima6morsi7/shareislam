...
if( !function_exists( 'mars_home_v5_1col_lefts_sidebar' ) ){
	function mars_home_v5_1col_lefts_sidebar($data) {
		$template               = array();
		$template['name']       = __( 'Homepage V5 - 1Col - Left Sidebar', 'mars' );
		$template['image_path'] = get_template_directory_uri() .'/img/home_v5_1col_lefts_sidebar.png'; // always use preg replace to be sure that "space" will not break logic
		$template['custom_class'] = 'mars_home_v5_1col_lefts_sidebar';
