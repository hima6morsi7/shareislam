<?php
	...
	*	---------------------------------------------------------------------
	*	This file manages all fonts in this framework including Cufon and 
	...
	*/
	...
	// get custom upload font from the CrunchPress panel
	get_uploaded_font();
	function get_uploaded_font(){
	
		global $all_font;
		global $crunchpress_element;
		$upload_font_xml = get_option($crunchpress_element['cp_panel_upload_font']['UPLOAD FONT']['name']);
	...
	$all_font = array_merge($all_font, array(
		'Cufon' => array(
			...
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon.js'),
			
		'Aller' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Aller_400.font.js'),
			
		'Bebas' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Bebas_400.font.js'),		
			
		'Cabin Cufon' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Cabin_400.font.js'),
						
		'Cantarell Cufon' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/cantarell.js'),
			
		'Cicle Gordita' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Cicle_Gordita_700.font.js'),
			
		'Colaborate Light' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/ColaborateLight_400.font.js'),

		'Gnuolane Free' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Gnuolane_Free_400.font.js'),	
			
		'Josefin Sans Cufon' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Josefin_Sans_Std_300.font.js'),	
			
		'Luxi Serif' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Luxi_Serif_400.font.js'),
						
		'Museo Sans' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Museo_Sans_500.font.js'),
									
		'Nobile Cufon' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Nobile_400.font.js'),
									
		'Oswald Cufon' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Oswald_400.font.js'),
			
		'Quicksand Book' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Quicksand_Book_400.font.js'),
			
		'Samba' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Samba_400.font.js'),
						
		'Sansation' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Sansation_400.font.js'),
			
		'Yanone Kaffeesatz Cufon' => array(
			'status'=>'enabled',
			'type'=>'Cufon',
			'is-used'=>false,
			'path'=>CP_PATH_URL.'/javascript/cufon/Yanone_Kaffeesatz_400.font.js'),
	));
	...
	function is_font_used(){
		global $all_font, $crunchpress_element;
		
		foreach($crunchpress_element['cp_panel_font'] as $field){
