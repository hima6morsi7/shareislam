<?php
	...
	*/
	...
	$portfolio_meta_boxes = array(	
		...
		"Clients Name" => array(
			'title'=> __('CLIENTS NAME', 'crunchpress'),
		...
		"Website Url" => array(
			'title'=> __('WEBSITE URL', 'crunchpress'),
		...
		"Thumbnail Image Type" => array(
			'title'=> __('USE FEATURED IMAGE AS', 'crunchpress'),
		...
		"Thumbnail Image URL" => array(
			'title'=> __('SPECIFIC URL', 'crunchpress'),
	...
	function add_portfolio_option(){	
		...
		add_meta_box('portfolio-option', __('Portfolio Option','crunchpress'), 'add_portfolio_option_element',
