...
Contributors: Ronny Sherer
Tags: admin, rtl, hebrew, arabic, farsi, persian, urdu
...
== Screenshots ==
1. Before clicking LTR<=>RTL
2. After clicking LTR<=>RTL
...
= 0.4 =
* Add banner and icon to wordpress.org
