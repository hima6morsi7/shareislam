    ...
    <div class="doc_settings_details">
        ...
        <div class="doc_content_steps_integration">
            ...
            <ul class="ul_custom_fields">
                <li>
                    Set <span class="custom_field_key">wpzoom_video_type</span> To <code>external</code>  
                </li>  
                <li>
                    Set <span class="custom_field_key">wpzoom_post_embed_location</span> To <code>Before everything else</code>  
                </li>                
                <li>
                    Set <span class="custom_field_key">wpzoom_post_embed_code</span> To
                    <code>
