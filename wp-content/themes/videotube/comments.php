	  ...
	  'fields' => apply_filters( 'comment_form_default_fields', array(
		'author'	=>	'
		  <div class="form-group">
			...
			<input required="required" type="text" class="form-control" id="author" name="author" placeholder="'.__('Enter name','mars').'" value="' . esc_attr( $commenter['comment_author'] ) .'">
		  </div>			
		',
		'email'	=>	'
		  <div class="form-group">
			<label for="email">'.__('Your Email','mars').'</label>
			<input required="required" type="email" class="form-control" id="email" name="email" placeholder="'.__('Enter Email','mars').'" value="' . esc_attr(  $commenter['comment_author_email'] ) .'">
		  </div>
		',
		'url'	=>	'
		  <div class="form-group">
