...
Redux::setSection( $opt_name, array(
	...
	'fields'	=>	array(
		...
		array(
			...
			'type'	=>	'text',
			'desc'	=>	sprintf(
				__('The maximum video file size allowed, 10MB is default size, this size must be smaller than %sMB','mars'),
		...
		array(
			...
			'type'	=>	'text',
			'desc'	=>	sprintf(
				__('The maximum Preview Image size allowed, 2MB is default size, this size must be smaller than %sMB','mars'),
				wp_max_upload_size()/1024/1024
			),
			'default'	=>	2
		),					
...
Redux::setSection( $opt_name, array(
	...
	'fields'	=>	array(
		...
		array(
			...
			'options' => array('default' => __('Default','mars'), 'videotube' => __('Diffing','mars')),
			'default' => 'videotube'
		),
		...
		array(
			'id' => 'read_more_less',
			'type' => 'switch',
			'title' => __('Read more/read less', 'mars'),
			"default" => '1',
			'on' => __('Yes','mars'),
			'off' => __('No','mars'),
		),
		array(
			...
			'type' => 'select',
			'multi' => false,
			'title' => __('Desktop Columns', 'mars'),
			"default" => 3,
			"options"	=>	array(
				'1'	=>	esc_html__( '1 column', 'mars' ),
				'2'	=>	esc_html__( '2 columns', 'mars' ),
				'3'	=>	esc_html__( '3 columns', 'mars' ),
				'4'	=>	esc_html__( '4 columns', 'mars' ),
				'6'	=>	esc_html__( '6 columns', 'mars' )
			)
		),
		array(
			'id' => 'tablet_columns',
