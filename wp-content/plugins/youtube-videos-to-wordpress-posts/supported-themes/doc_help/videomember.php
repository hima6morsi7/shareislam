<div class="theme_documenation">
    <div class="doc_settings_details">
        ...
        <p>
            Go to <code>Default import settings</code> and go to the <code>General Options</code> tab.
        </p>
        <div class="doc_separateur"></div>
        <ul class="ul_doc_first">
            <li>
                Set <span class="custom_field_key">Content type</span> to <code>video_listing</code>
            </li>                
        </ul>        
        ...
        <div class="doc_content_steps_integration">
            ...
            <ul class="ul_custom_fields">
                <li>
                    Set <span class="custom_field_key">_video_url</span> To <code>{{video_url}}</code>  
                </li> 
                <li>
                    Set <span class="custom_field_key">post_views_count</span> To <code>{{video_views}}</code>  
                </li>  
                <li>
                    Set <span class="custom_field_key">likes</span> To <code>{{video_likes}}</code>  
                </li> 
                <li>
                    Set <span class="custom_field_key">dislikes</span> To <code>{{video_dislikes}}</code>  
                </li>                   
                
                <li>
                    Set <span class="custom_field_key">featured_video</span> To<code>off</code>       
                </li>
            </ul>
        </div>
    </div>
