...
class Mars_FeaturedPosts_Widgets_Class extends WP_Widget{
		            	...
		            	<div class="row">
		                     <div class="carousel-inner">
		                       	...
		                       	if( $wp_query->have_posts() ) : 
			                       	...
			                       	<?php endif;?>	
			                                <div id="video-featured-<?php the_ID()?>" class="col-md-<?php print $class_columns;?> col-sm-<?php echo esc_attr( $tablet_columns )?> col-xs-<?php echo esc_attr( $mobile_columns );?> <?php print $this->id; ?>-<?php print get_the_ID();?>">
				                                <?php 
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['tablet_columns']	=	absint( $new_instance['tablet_columns'] );
		$instance['mobile_columns']	=	absint( $new_instance['mobile_columns'] );
