    ...
    <div class="doc_settings_details">
        ...
        <div class="doc_content_steps_integration">
            ...
            <ul class="ul_custom_fields">
                <li>
                    Set <span class="custom_field_key">tie_post_head</span> To <code>video</code>  
                </li>  
                <li>
                    Set <span class="custom_field_key">tie_video_url</span> To <code>{{video_url}}</code>  
                </li> 
                <li>
                    Set <span class="custom_field_key">tie_views</span> To <code>{{video_views}}</code>  
                </li>               
                <li>
                    Set <span class="custom_field_key">tie_embed_code </span> To
                    <code>
