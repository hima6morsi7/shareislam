				...
				if( $type == 'widget' && $carousel == 'on' ):
		                    	...
		                    	<div class="row">
			                     <div class="carousel-inner">
			                       	...
			                       	if( $wpquery->have_posts() ) : 
				                       	...
				                       	<?php endif;?>	
				                       		<div id="video-<?php the_ID();?>" class="col-md-<?php print $class_columns;?> col-sm-<?php echo esc_attr( $tablet_columns );?> col-xs-<?php echo esc_attr( $mobile_columns );?> item responsive-height post video-<?php print get_the_ID();?>">
				                                <div class="item-img">
													<?php 
					...
					<div id="<?php print esc_attr( $id );?>" class="row columns-<?php print $columns;?> video-section meta-maxwidth-230 <?php print $el_class;?>"> 
						<?php while ( $wpquery->have_posts() ): $wpquery->the_post(); ?>
							<div class="col-md-<?php print $class_columns;?> col-sm-<?php echo esc_attr( $tablet_columns );?> col-xs-<?php echo esc_attr( $mobile_columns );?> item responsive-height post">
								<div class="item-img">
									<?php 
									if(has_post_thumbnail()):
