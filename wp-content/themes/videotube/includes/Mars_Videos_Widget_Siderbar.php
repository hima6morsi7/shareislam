	...
	function widget($args, $instance){
		...
		?>
	        <div class="row">
	        	...
	        	?>
	            <div class="col-md-<?php echo esc_attr( $widget_column )?> col-sm-<?php echo esc_attr( $tablet_columns );?> col-xs-<?php echo esc_attr( $mobile_columns );?> item responsive-height <?php print $this->id; ?>-<?php print get_the_ID();?>">
	            	<div class="item-img">
	            	<?php 
